...
export function ContactPage() {
  ...
  return (
    <PageShell>
      ...
      <section className="contact-main"><div className="contact-details"><SectionLabel number="01">Get in touch / Visit by appointment</SectionLabel><div className="contact-detail-block"><span>Phone</span><a href="tel:+842873048890">+84 28 7304 8890</a></div><div className="contact-detail-block"><span>Studio</span><p style={{ fontSize: "22px" }}>SH Hotel Phnom Penh<br />137 Preah Ang Yukanthor Street, 136, Phnom Penh</p></div><div className="contact-detail-block"><span>Elsewhere</span><div className="social-row"><a href="https://instagram.com" target="_blank" rel="noreferrer">Instagram <ArrowUpRight size={13} /></a><a href="https://facebook.com" target="_blank" rel="noreferrer">Facebook <ArrowUpRight size={13} /></a><a href="https://linkedin.com" target="_blank" rel="noreferrer">LinkedIn <ArrowUpRight size={13} /></a></div></div><a className="map-link" href="https://maps.google.com/?q=SH+Hotel+Phnom+Penh+137+Preah+Ang+Yukanthor+Street+136+Phnom+Penh" target="_blank" rel="noreferrer"><span>Open in Google Maps</span><ArrowUpRight size={16} /><div className="map-grid"><i /><i /><i /><b /></div></a></div>
